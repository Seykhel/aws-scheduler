# This Terraform module creates an EC2 scheduler using AWS Lambda and CloudWatch Events.
# It provisions a Lambda function that starts or stops EC2 instances based on a specified cron schedule.
# The module also creates the necessary IAM roles, policies, and CloudWatch resources.
...
data "archive_file" "lambda_zip" {
  type        = "zip"
  output_path = "ec2_lambda_function.zip"
  source {
